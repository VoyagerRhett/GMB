...
//! citizenwallet 内部账户数据用途钥派生与冷钱包加密交付实现。
//!
...
macro_rules! export_account_crypto_ffi {
    () => {
        ...
        pub unsafe extern "C" fn account_crypto_derive_key(
            ...
            $crate::account_crypto::ffi_derive_key(
                account_secret,
                genesis_hash,
                cid_number,
                cid_number_len,
        ...
        pub unsafe extern "C" fn account_crypto_x25519_public_key(
            ...
            $crate::account_crypto::ffi_x25519_public_key(secret, output)
        }

//! citizenwallet 内部 sr25519 原生签名 FFI（schnorrkel）。
//!
...
macro_rules! export_citizen_signer_ffi {
    () => {
        ...
        pub unsafe extern "C" fn citizen_sr25519_derive_hard(
            ...
            $crate::sr25519::citizen_sr25519_derive_hard(seed, chain_code, out_child)
        }
        ...
        pub unsafe extern "C" fn citizen_sr25519_public_key(
            ...
            $crate::sr25519::citizen_sr25519_public_key(child, out_public)
        }
        ...
        pub unsafe extern "C" fn citizen_sr25519_sign(
            ...
            $crate::sr25519::citizen_sr25519_sign(child, message, message_len, out_signature)
        }
        ...
        pub unsafe extern "C" fn citizen_sr25519_verify(
            ...
            $crate::sr25519::citizen_sr25519_verify(public, signature, message, message_len)
        }
    };
}

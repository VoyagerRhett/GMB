/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=scripts/wrangler.toml --env-interface=CloudflareBindings scripts/worker-configuration.d.ts` (hash: 4fe28cdb6eccffcdd475fe1551a751c2)

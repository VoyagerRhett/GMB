...
#if defined(_WIN32) && defined(CITIZENSDK_HOST_BUILDING)
#define CITIZENSDK_HOST_API __declspec(dllexport)
#elif defined(_WIN32)
#define CITIZENSDK_HOST_API __declspec(dllimport)
#else
...
CITIZENSDK_HOST_API citizensdk_error_code_t citizensdk_host_set_parent_window(
    citizensdk_host_handle_t host, void *hwnd);

#ifndef CITIZENSDK_LINUX_FLUTTER_WALLET_FLOW_HPP
#define CITIZENSDK_LINUX_FLUTTER_WALLET_FLOW_HPP
...
// presenter is the existing Host GTK wallet flow; no mnemonic/password/private
...
class FlutterWalletFlows final {
 public:
  ...
  // still owns the entry until the existing GTK flow reports its outcome.

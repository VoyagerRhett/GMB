...
// 本文件只执行 gmb.citizensdk.sdk.ci 的 linuxamd Job；阶段编号由本仓唯一 Workflow 固定，禁止接收其它身份。
export const EXACT_REMOTE_JOB_IDENTITY = Object.freeze({"pipeline":"gmb.citizensdk.sdk.ci","job":"linuxamd"});

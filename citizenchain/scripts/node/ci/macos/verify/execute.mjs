...
// 本文件只执行 gmb.citizenchain-node.macos.ci 的 verify Job；阶段编号由本仓唯一 Workflow 固定，禁止接收其它身份。
export const EXACT_REMOTE_JOB_IDENTITY = Object.freeze({"pipeline":"gmb.citizenchain-node.macos.ci","job":"verify"});

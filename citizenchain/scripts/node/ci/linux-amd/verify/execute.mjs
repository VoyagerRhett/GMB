...
// 本文件只执行 gmb.citizenchain-node.linux-amd.ci 的 verify Job；阶段编号由本仓唯一 Workflow 固定，禁止接收其它身份。
export const EXACT_REMOTE_JOB_IDENTITY = Object.freeze({"pipeline":"gmb.citizenchain-node.linux-amd.ci","job":"verify"});
...
const workflowSteps = Object.freeze({"0":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" prepare"},"1":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" wire"},"2":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" sanitize"},"3":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/index.mjs\" linux-deps"},"4":{"shell":"bash","source":"case \"$RUNNER_OS/$RUNNER_ARCH\" in\n  Linux/ARM64) platform=linux-arm ;;\n  Linux/X64) platform=linux-amd ;;\n  *) echo 'CitizenChain Linux protoc宿主不受支持' >&2; exit 1 ;;\nesac\nprotoc_executable=\"$(node citizenchain/scripts/dependencies.mjs prepare protoc \"$platform\" \"$RUNNER_TEMP/citizenchain-protoc/$platform\")\"\n{\n  echo \"LLVM_CONFIG_PATH=$(command -v llvm-config)\"\n  echo \"LIBCLANG_PATH=$(llvm-config --libdir)\"\n  echo \"PROTOC=$protoc_executable\"\n} >> \"$GITHUB_ENV\"\n"},"5":{"shell":"bash","source":"npm --prefix citizenchain/crates/scanner-react ci\nnpm --prefix citizenchain/crates/scanner-react run check\nnpm --prefix citizenchain/crates/scanner-react test\n"},"6":{"shell":"bash","source":"python3 citizenchain/scripts/check-constitution-genesis.py --self-test"},"7":{"shell":"bash","source":"npm --prefix citizenchain/node/frontend ci\nnpm --prefix citizenchain/node/frontend run build\n"},"8":{"shell":"bash","source":"cargo --config \"$GITHUB_WORKSPACE/citizenchain/config.toml\" fmt --all -- --check\n"},"9":{"shell":"bash","source":"cargo --config \"$GITHUB_WORKSPACE/citizenchain/config.toml\" clippy --workspace --all-targets --locked -- -D warnings\n"},"10":{"shell":"bash","source":"cargo --config \"$GITHUB_WORKSPACE/citizenchain/config.toml\" test --workspace --all-targets --locked\n"},"11":{"shell":"bash","source":"npm --prefix citizenchain/onchina/frontend ci\nnpm --prefix citizenchain/onchina/frontend run build\n"},"12":{"shell":"bash","source":"npm --prefix citizenchain/onchina/frontend test"},"13":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" sanitize\nnode \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" record\n"},"14":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" prune"},"15":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" sanitize\nnode \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" record\n"},"16":{"shell":"bash","source":"node \"$GITHUB_WORKSPACE/citizenchain/scripts/node/ci/linux-amd/verify/execute.mjs\" prune"}});

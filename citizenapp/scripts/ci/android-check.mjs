...
export const jobIdentity = Object.freeze({"pipeline":"gmb.citizenapp.android.ci","job":"check"});
export const workflowSteps = Object.freeze({
  ...
  "1": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" prepare"
  },
  "2": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" wire"
  },
  "3": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" sanitize"
  },
  "4": {
    "shell": "bash",
  ...
  "10": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" sanitize\nnode \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" record\n"
  },
  "11": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" prune"
  },
  "12": {
    "shell": "bash",
    "source": "node \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" sanitize\nnode \"$GITHUB_WORKSPACE/citizenapp/scripts/ci/android-check.mjs\" record\n"
